...
<%@ include file = "hnav1.jsp" %>
 ...
 <div class="container">
 	...
 	<div class="row myhdrow">
 		<div class="col-6 "><a href="HostInfoImagesView" type="button" style="border-radius: 10px; width:400px; height: 60px;" class="btn mybtns btn-secondary">이미지</a></div>
 		<div class="col-6 "><a href="HostInfoRoughView" type="button" style="border-radius: 10px; width:400px; height: 60px;" class="btn mybtns btn-secondary">약도</a></div>
 	</div>
 	<div class="row myhdrow">
