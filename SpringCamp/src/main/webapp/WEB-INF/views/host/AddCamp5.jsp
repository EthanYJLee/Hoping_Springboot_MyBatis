...
<div class="container">
	...
	<div class="row">
					...
					<table>
						...
						<c:forEach items="${roomlist}" var="dto">
							<tr class="myhtr">
								...
								<td class="mytd">
									<a href="delete_rooms?roSeq=${dto.roSeq}" type="button" class="btn btn-secondary" style="height: 30px; font-size: 13px;" >
										삭제 
									</a>
								</td>
							</tr>
		...
		<%-- 등록 폼 --%>
			<div class="container ">
				<%-- 추가 form --%>
				<form name ="Member" action="add_rooms" method="post">
