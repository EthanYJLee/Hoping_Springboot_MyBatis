...
<%@ include file = "hnav1.jsp" %>
 ...
 <div class="container">
 	<div class="row myhdrow">
 		<h5 class="col-12" style="margin: 20px 0 20px 0">캠핑장의 위치를 등록하기</h5>
 		<%-- map 위치 검색 --%>
 		<div class="map_wrap">
		...
		<form action="add_camp_location" name="Member" class="myscontainer">
			...
			<div class="myscontainer">
				주소 : <input class="myinfoinput" name="regDetailaddress" type="text" placeholder="캠핑장의 위치를 지도에서 선택해주세요." id="hostaddress">
			</div>
			<%--- map --%>
			<div id="map" style="width: 100%; height: 60vh;"></div>
	 		...
	 		<%-- 캠핑장 설명 수정 --%>
		 	<div class="row myhdrow">
		 		<h5 class="col-12" style="margin: 20px 0 20px 0">캠핑장의 설명을 추가하기</h5>
		 		<input type="text" name="regSummary" class="myinputtext form-control" aria-label="text">
		 	</div>
		 	
		 	
		 	<%-- 캠핑장 이름 등록 --%>
		 	<h5 class="col-12" style="margin: 20px 0 20px 0">캠핑장의 이름을 등록하기</h5>
	 		<input name="regName" type="text" class="form-control" aria-label="text">
