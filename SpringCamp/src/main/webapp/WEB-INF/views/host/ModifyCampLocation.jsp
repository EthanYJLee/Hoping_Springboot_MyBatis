...
<%@ include file = "hnav1.jsp" %>
 ...
 <div class="container">
 	<div class="row myhdrow">
 		...
 		<div class="myscontainer">기존 위치는 "${campLocationList.regDetailaddress}"예요</div>
		...
		<form name="Member" action="modify_camp_location" class="myscontainer">
			...
			<div class="myscontainer">
				주소 : <input class="myinfoinput" value="${campLocationList.regDetailaddress}" name="regDetailaddress" type="text" placeholder="캠핑장의 위치를 지도에서 선택해주세요." id="hostaddress">
			</div>
			<%--- map --%>
			...
			<p id="result"></p>
		 	...
		 	<div class="row myhdrow ">
		 		...
		 		<input type="text" name="regSummary" class="myinputtext form-control" aria-label="text" value="${campLocationList.regSummary}">
		 	</div>
