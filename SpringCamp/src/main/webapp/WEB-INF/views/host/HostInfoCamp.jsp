...
<%-- 상세정보 --%>
 <div class="container myscontainer">
 	...
 	<div class="row justify-container-center">
			<div class="col-md">
				<img style="margin-bottom: 20px; border-radius: 5px; width: 18rem;"
					src="images/${campInfo.regImage1}" 
					class="card" alt="...">
			</div>
			<div class="col-md">
				<img style="margin-bottom: 20px; border-radius: 5px; width: 18rem;"
					src="images/${campInfo.regImage2}" 
					class="card" alt="...">
			</div>
			<div class="col-md">
				<img style="margin-bottom: 20px; border-radius: 5px; width: 18rem;"
					src="images/${campInfo.regImage3}" 
					class="card" alt="...">
			</div>
	...
	<div class="row myhdrow myscontainer" style="padding-bottom: 25px;">
 		<div class="col ">
	 		<div class="card col-md" style="border: 0px solid black;">
	 			<div class="myhdth">캠핑장 이름</div><div class="myhdtd">${campInfo.regName}</div>
	 		</div><br>
	 		<div class="card col-md" style="border: 0px solid black;">
	 			<div class="myhdth">카테고리</div><div class="myhdtd">${campInfo.regCategory}</div>
	 		</div><br>
	 		<div class="card col-md" style="border: 0px solid black;">
	 			<div class="myhdth">전화번호</div><div class="myhdtd">${campInfo.regTel}</div>
	 		</div>
 		</div>
 		<div class="col">
	 		...
	 		<div class="col-md">
				<img style="margin-bottom: 20px; border-radius: 5px; width: 18rem;"
					src="images/${campInfo.regImage4}" 
					class="card" alt="...">
			</div>
 		</div>
 		<div class="col">
 			<div class="myhdth">위치</div>
 			<div class="myhdtd">${campInfo.regDetailaddress}</div>
 		...
 		<div class="container myscontainer">
	 		<c:forEach items="${keywordInfo}" var="dto">
 		...
 		<div class="container myscontainer">
			<c:forEach items="${facilityInfo}" var="dto">
		 		<input type="checkbox" class="btn-check" name="keys" id="option1" value="조용한"  autocomplete="off">
 		...
 		<div class="row myscontainer justify-content-center">
			<div class="card col-5 myhcard" style="border-radius: 20px;">
				<table class="d-flex justify-content-center">
					...
					<%-- for문 돌리기 --%>
					<c:forEach items="${roomInfo}" var="dto">
						<tr class="myhtr">
	...
	<div class="d-flex justify-content-end">
		<a href="modify_camp" type="button" style="border-radius: 15px; width:70px;" class="btn mybtns btn-secondary">확인</a>
	</div>
</div>
