 ...
 <div class="container">
 	<form name="Member" action="modify_camp_name">
	 	<div class="row myhdrow">
	 		...
	 		<div class="container">
	 			<div>기존 이름 <b>"${campNameList.regName}"</b></div>
	 			<input name="regName" value="${campNameList.regName}" type="text" class="form-control" aria-label="text">
	 		</div>
	 	</div>
	 	<div class="row myhdrow">
	 		<h5 class="col-12" style="margin: 20px 0 20px 0">전화번호를 수정하기</h5>
	 		<div class="container">
	 			<div>기존 전화번호 <b>"${campNameList.regTel}"</b></div>
	 			<input name="regTel" value="${campNameList.regTel}" type="text" class="form-control" aria-label="text">
	 		</div>
	 	</div>
	 	<div class="row myhdrow">
