...
<script type="text/javascript">
    ...
    function confirmLogout() {
        if( confirm("정말 로그아웃 하시겠습니까?") ) {
            location.href = "<c:url value ='ClientLogout'/>";
        }
    }
...
<div class="container">
   <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
     <a href="host_main" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
     ...
     <ul class="nav nav-pills">
     	<li class="nav-item" style="font-size: 14px;">
	     		...
	     		<a href="main" class="link-dark nav-link"> Change Client Mode</a>
	     			  <% } %>	
	     	</li>
     	<li class="nav-item">
		...
		<ul class="dropdown-menu dropdown-menu-end">
			...
			<li><a class="dropdown-item" href="bookList">예약목록</a></li>
			<li><a class="dropdown-item" href="askList">문의목록</a></li>
            <li><a class="dropdown-item" href="detail_stat_view">수입 및 예약건 통계</a></li>
            <li><a class="dropdown-item" href="review_list">후기관리</a></li>
            <li><a class="dropdown-item" href="campingAdd">캠핑장 추가</a></li>
