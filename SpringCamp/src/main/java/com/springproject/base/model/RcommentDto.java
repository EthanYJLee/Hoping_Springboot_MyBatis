...
public class RcommentDto {
	...
	public RcommentDto(int rcSeq, String rcContent, Timestamp rcTime, Timestamp rcMtime, Timestamp rcDtime, int rcLevel,
	...
	public Timestamp getRcMtime() {
		return rcMtime;
	}

	public void setRcMtime(Timestamp rcMtime) {
		this.rcMtime = rcMtime;
	}
